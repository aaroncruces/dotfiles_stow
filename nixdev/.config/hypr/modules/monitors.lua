...
-- ========================
local primary_monitor    = "desc:Samsung Electric Company S24R35A H4TT303101"   -- BenQ (primary/gaming)
local secondary1_monitor = "desc:AU Optronics 0x7EAD 0x00007EAD"      
local secondary2_monitor = "desc:Samsung Electric Company S22F350 HCNT201138"         -- HP (secondary 2)
...
-- ========================
local primary_work_mode   = "1920x1080@75"
local primary_gaming_mode = "1920x1080@60"
local primary_position    = "1920x0"

local secondary1_mode     = "1920x1080@144"
local secondary1_position = "0x0"

local secondary2_mode     = "1920x1080@60"
local secondary2_position = "3840x0"
